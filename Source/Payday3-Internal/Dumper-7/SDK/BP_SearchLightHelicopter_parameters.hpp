...
struct BP_SearchLightHelicopter_C_CheckDistanceToGround final
{
public:
...
DUMPER7_ASSERTS_BP_SearchLightHelicopter_C_CheckDistanceToGround;

// Function BP_SearchLightHelicopter.BP_SearchLightHelicopter_C.UserConstructionScript
// 0x0002 (0x0002 - 0x0000)
struct BP_SearchLightHelicopter_C_UserConstructionScript final
{
public:
	bool                                          CallFunc_IsDedicatedServer_ReturnValue;            // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_ApplyVariationToSkeletal_ReturnValue;     // 0x0001(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
DUMPER7_ASSERTS_BP_SearchLightHelicopter_C_UserConstructionScript;

// Function BP_SearchLightHelicopter.BP_SearchLightHelicopter_C.ExecuteUbergraph_BP_SearchLightHelicopter
// 0x0178 (0x0178 - 0x0000)
struct BP_SearchLightHelicopter_C_ExecuteUbergraph_BP_SearchLightHelicopter final
{
public:
	...
	struct FHitResult                             CallFunc_K2_SetWorldLocationAndRotation_SweepHitResult; // 0x001C(0x0090)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FVector                                CallFunc_CheckDistanceToGround_Location_1;         // 0x00AC(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_CheckDistanceToGround_DistanceToGround_1; // 0x00B8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_FloatFloat_ReturnValue;              // 0x00BC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsDedicatedServer_ReturnValue;            // 0x00BD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_ApplyVariationToSkeletal_ReturnValue;     // 0x00BE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
DUMPER7_ASSERTS_BP_SearchLightHelicopter_C_ExecuteUbergraph_BP_SearchLightHelicopter;
