...
// Package: BP_PlanksPileRequirement

#include "Basic.hpp"

#include "BP_PlanksPileRequirement_classes.hpp"
#include "BP_PlanksPileRequirement_parameters.hpp"


namespace SDK
{

// Function BP_PlanksPileRequirement.BP_PlanksPileRequirement_C.BP_CheckRequirement
...
bool UBP_PlanksPileRequirement_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_PlanksPileRequirement_C", "BP_CheckRequirement");

	Params::BP_PlanksPileRequirement_C_BP_CheckRequirement Parms{};
