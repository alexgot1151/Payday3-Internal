...
public:
	...
	bool                                          CallFunc_TextIsEmpty_ReturnValue;                  // 0x012D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x012E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_12F[0x1];                                      // 0x012F(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class USBZEquippableData*                     K2Node_DynamicCast_AsSBZEquippable_Data;           // 0x0130(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Temp_bool_Variable_1;                              // 0x018D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSBZWeaponModificationUIData           CallFunc_Array_Get_Item;                           // 0x0220(0x0018)()
	...
	struct FSBZWeaponModificationUIData           CallFunc_Array_Get_Item_1;                         // 0x0278(0x0018)()
