...
struct BP_CarriedRedKeycard_C_UserConstructionScript
{
public:
...
struct BP_CarriedRedKeycard_C_GetSensorOutlineComponent
{
public:
...
// 0x0008 (0x0008 - 0x0000)
struct BP_CarriedRedKeycard_C_GetSensorComponent
{
public:
