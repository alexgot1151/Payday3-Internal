...
#include "BP_LA_Scripted_Idle_classes.hpp"
#include "BP_LA_Scripted_Idle_parameters.hpp"
...
void ABP_LA_Scripted_Idle_C::BndEvt__BP_LA_Manager_Scripted_TableButtonPress_SBZLifeAction_K2Node_ComponentBoundEvent_1_SBZLifeActionEventDelegate__DelegateSignature(class ASBZCharacter* Character, class USBZLifeActionInstance* ActionInstance, class USBZLifeActionSlot* ActionSlot)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_LA_Scripted_Idle_C", "BndEvt__BP_LA_Manager_Scripted_TableButtonPress_SBZLifeAction_K2Node_ComponentBoundEvent_1_SBZLifeActionEventDelegate__DelegateSignature");

	Params::BP_LA_Scripted_Idle_C_BndEvt__BP_LA_Manager_Scripted_TableButtonPress_SBZLifeAction_K2Node_ComponentBoundEvent_1_SBZLifeActionEventDelegate__DelegateSignature Parms{};
