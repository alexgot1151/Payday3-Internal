...
#include "BP_FuelRequirement_classes.hpp"
#include "BP_FuelRequirement_parameters.hpp"
...
bool UBP_FuelRequirement_C::BP_CheckRequirement(const class USBZInteractorComponent* Interactor, struct FSBZInteractReqData* OutData, bool bIsSignalRequired, bool bInIsScreenInteract, bool bIsCasing, bool bIsEncumbered) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_FuelRequirement_C", "BP_CheckRequirement");

	Params::BP_FuelRequirement_C_BP_CheckRequirement Parms{};
