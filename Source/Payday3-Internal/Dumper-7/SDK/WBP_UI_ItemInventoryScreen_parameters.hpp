...
public:
	...
	class UWBP_UI_Inventory_ItemSlotButton_C*     K2Node_DynamicCast_AsWBP_UI_Inventory_Item_Slot_Button; // 0x0010(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
