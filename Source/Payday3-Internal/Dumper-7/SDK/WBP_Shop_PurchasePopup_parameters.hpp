...
public:
	...
	struct FSBZItemBundleStoreItem                K2Node_Event_InItemBundle;                         // 0x0038(0x0110)(ConstParm)
	int32                                         K2Node_Select_Default_2;                           // 0x0148(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              K2Node_Select_Default_3;                           // 0x014C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_bIsOwned;                             // 0x014D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_bIsVendorPermission;                  // 0x014E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              K2Node_Select_Default_4;                           // 0x014F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UWBP_UI_WeaponSlotDisplayPanel_C*       K2Node_DynamicCast_AsWBP_UI_Weapon_Slot_Display_Panel; // 0x0150(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   K2Node_Select_Default_5;                           // 0x0178(0x0018)(ConstParm)
};
...
public:
	...
	struct FSBZItemBundleStoreItem                InItemBundle;                                      // 0x0008(0x0110)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
