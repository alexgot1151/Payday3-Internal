...
// BlueprintGeneratedClass BPL_DeskLamp_01_PBL.BPL_DeskLamp_01_PBL_C
// 0x0030 (0x0320 - 0x02F0)
class ABPL_DeskLamp_01_PBL_C final : public ASBZReplicatedIntStateActor
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x02F0(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UStaticMeshComponent*                   LGT_DeskLamp_01;                                   // 0x02F8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void ExecuteUbergraph_BPL_DeskLamp_01_PBL(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BPL_DeskLamp_01_PBL_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BPL_DeskLamp_01_PBL_C")
	}
	static class ABPL_DeskLamp_01_PBL_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABPL_DeskLamp_01_PBL_C>();
	}
};
DUMPER7_ASSERTS_ABPL_DeskLamp_01_PBL_C;
